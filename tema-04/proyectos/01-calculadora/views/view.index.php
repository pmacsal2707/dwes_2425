  ...
  <div class="container">
    ...
    <form method="GET" action="calculadora.php">
      ...
      <div class="btn-group" role="group">
        ...
        <button type="submit" class="btn btn-outline-primary" name="operacion" value="sumar">Sumar</button>
        <button type="submit" class="btn btn-outline-warning" name="operacion" value="restar">Restar</button>
        <button type="submit" class="btn btn-outline-success" name="operacion" value="multiplicar">Multiplicar</button>
        <button type="submit" class="btn btn-outline-danger" name="operacion" value="dividir">Dividir</button>
      </div>
